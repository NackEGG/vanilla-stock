...
<html>
  ...
  <body>
    ...
    <div id="content">
      <div class="aux">
           <form:form role="form" modelAttribute="registerRequest" action="join/welcome" method="post">
        <div id="signup">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <tr>
						            ...
						            <%-- <form:form role="form" commandName="registerRequest" action="join/welcome" method="post"> --%>
						        <div class="panel-body">
								    <div class="row">
								        
						                <div class="input_group">
						                    <span class="join_subject">이메일</span><br>
						                    <form:input type="email" class="join_inputbox" placeholder="Email" path="email"/>						                    
						                </div>
						                <div class="input_group">
						                    <span class="join_subject">닉네임</span><br>
						                    <form:input type="text" class="join_inputbox" placeholder="Nickname" path="nickname"/>
						                    <form:errors path="nickname"/>
						                </div>
						                <div class="input_group">
						                    <span class="join_subject">비밀번호</span><br>
						                    <form:password class="join_inputbox" placeholder="Password" path="pw"/>
						                    <form:errors path="pw"/>
						                </div>
						                <div class="input_group">
						                    <span class="join_subject">비밀번호 확인</span><br>
						                    <form:password class="join_inputbox" placeholder="Password Check" path="checkPw"/>
						                    <form:errors path="checkPw"/>
						                </div>
						                <div class="input_group">
						                    <span class="join_subject">생년월일</span><br>
						                    <form:select type="text" placeholder="BDYear" path="BDYear">
			                                    <%for(int i=2020; i>=1950; i--){%>
				                                    <option value="<%out.print(String.format("%4d", i)); %>"
													<%if(i == 2020){%> 
													 selected>
						                    ...
						                    <form:errors path="BDYear"/>
						                
						                    <form:select type="text" placeholder="BDMon" path="BDMon">	
			                                     <%for(int i=1; i<=12; i++){%>
				                                    <option value="<%out.print(String.format("%02d", i)); %>"
													<%if(i == 1){%> 
													 selected>
						                    ...
						                    <form:errors path="BDMon"/>
						                
						                    <form:select type="text" placeholder="BDDay" path="BDDay">	
			                                     <%for(int i=1; i<=31; i++){%>
				                                    <option value="<%out.print(String.format("%02d", i)); %>"
													<%if(i == 1){%> 
													 selected>
						                    ...
						                    <form:errors path="BDDay"/>
						                </div>
						                <div class="input_groupp">
						                    <span class="join_subject">성별</span><br>
						                    <form:radiobutton value="M" label="남자" class="form-control"  path="gender"/>
						                    <form:radiobutton value="F" label="여자"  class="form-control"  path="gender"/>
